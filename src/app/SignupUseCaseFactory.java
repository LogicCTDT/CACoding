...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ClearController clearController = createUserClearUseCase(clearUserDataAccessInterface, viewManagerModel, clearViewModel, signupViewModel);
    ...
    private static ClearController createUserClearUseCase(ClearUserDataAccessInterface userDataAccessInterface,
        ...
        ClearInputBoundary userclearInteractor = new ClearInteractor(userDataAccessInterface, clearOutputBoundary);
